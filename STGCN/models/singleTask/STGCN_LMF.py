...
class STGCN_LMF(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.A_GCN = GCNsubnet(self.audio_in, self.audio_hidden, self.audio_hidden, args.seq_lens[1],
                               dropout=self.audio_prob, heads=args.nheads)
        ...
        self.V_GCN = GCNsubnet(self.video_in, self.video_hidden, self.video_hidden, args.seq_lens[2],
                               dropout=self.video_prob, heads=args.nheads)
